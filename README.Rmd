...
[fst](https://github.com/fstpackage/fst) package, which offers multi-threading
and support for most standard R object types.
...
2. Ignoring any attributes or dimensions, compress the data payload within 
   the object.
